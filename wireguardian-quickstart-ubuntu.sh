...
echo " "
read -p "This script will install Wireguardian on your system. Continue? (Y/n): " choice
case $choice in
  [Nn]* ) exit;;
esac
...
echo " "
read -p "Installation directory (/opt/wireguardian): " installdir
installdir=${installdir:-/opt/wireguardian}
...
echo " "
echo "Creating Wireguardian ingress routing network"
...
echo " "
echo "You can now start your Wireguardian instance with:"
echo "    cd ${installdir}"
